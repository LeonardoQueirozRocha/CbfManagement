...
namespace Cbf.Data.Migrations
{
    ...
    [Migration("20220709212400_Feature-torneios-partidas")]
    partial class Featuretorneiospartidas
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTorneio", b =>
                {
                    b.HasOne("Cbf.Business.Models.Time", null)
                        .WithMany()
                        .HasForeignKey("TimesId")
                        .IsRequired();

                    b.HasOne("Cbf.Business.Models.Torneio", null)
                        .WithMany()
